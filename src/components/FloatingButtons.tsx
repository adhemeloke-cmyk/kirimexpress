...
export const FloatingButtons: React.FC<FloatingButtonsProps> = ({
  ...
  const handleOpenWA = () => {
    const text = lang === 'zh'
      ? '您好 NK EXPRESS 客服，我想咨询特尔纳特-索菲菲路线的转运与包裹运输服务。'
      : 'Halo Admin NK EXPRESS, saya mau tanya pengiriman Jastip & Paket rute Ternate - Sofifi.';
    ...
    <div className="fixed bottom-4 right-4 z-40 flex flex-col items-end gap-3.5">
      ...
      <div className="relative flex items-center group">
        ...
        <button
          ...
          title={lang === 'zh' ? 'AI 智能客服' : 'Asisten AI CS NK EXPRESS'}
