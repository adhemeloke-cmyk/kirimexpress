        ...
        <div className="space-y-3 text-xs">
          ...
          <div className="bg-slate-50 border border-red-200 p-3 rounded-xl">
            ...
            <p className="text-emerald-600 font-semibold mt-1 flex items-center gap-1 text-[11px]">
              ...
              <a
                href={`https://wa.me/${WAREHOUSE_ADDRESSES.jakarta.rawPhone}?text=${encodeURIComponent('Halo NKExpress, saya ingin bertanya tentang layanan pengiriman paket.')}`}
                target="_blank"
          ...
          <div className="bg-slate-50 border border-red-200 p-3 rounded-xl">
            ...
            <p className="text-emerald-600 font-semibold mt-1 flex items-center gap-1 text-[11px]">
              ...
              <span>CS WhatsApp:{' '}</span>
              <a
                href={`https://wa.me/${WAREHOUSE_ADDRESSES.ternate.rawPhone}?text=${encodeURIComponent('Halo NKExpress, saya ingin bertanya tentang layanan pengiriman paket.')}`}
                target="_blank"
                rel="noopener noreferrer"
                className="font-bold underline hover:text-emerald-700 transition-colors cursor-pointer"
              >
