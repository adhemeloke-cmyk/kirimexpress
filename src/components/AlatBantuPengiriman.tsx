...
Nama: ${labelName.trim() || '......'}
Tujuan: ${labelDestination.trim() || (selectedWarehouseKey === 'ternate' ? 'TERNATE' : 'SOFIFI / TERNATE')}
HP: ${labelPhone.trim() || '......'}

ALAMAT GUDANG / WAREHOUSE (${activeWarehouse.title.toUpperCase()}):
${activeWarehouse.fullAddress}
${activeWarehouse.name} (Up. ${labelName.trim() || 'Penerima'})
Telp: ${activeWarehouse.phone}`;
